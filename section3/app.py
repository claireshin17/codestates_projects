...
model = pickle.load(open("codestates_projects/section3/flight_model.pkl", "rb"))
...
def predict():
    if request.method=='POST':
        ...
        des_dict={'Bangalore':0,'Cochin':1,'Delhi':2,'Hyderabad':3,'Kolkata':4,'New Delhi':5}
